...
- Tables with a composite primary key get their schema replicated but their rows skipped (`PlaylistTrack` is the one Chinook example). Composite-PK row copy is a follow-up — requires a key-encoding decision for the inGitDB record filename.
